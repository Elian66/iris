...
import image from '../../assets/images/hipertensao.jpg'
...
export default function Question7({ navigation }) {
    const nextStep = async (option) => {
        await AsyncStorage.setItem('points_step_8', String(option.points));
    ...
    return (
        <Div p={20} flex={1} justifyContent='center'>
            <Avatar
                ...
                source={image}
            />
            <Text fontSize={30}>Você tem hipertensão arterial?</Text>
            <Div >
