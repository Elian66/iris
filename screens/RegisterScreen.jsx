...
import { Avatar, Button, Div, Text, Input, Icon, Snackbar } from 'react-native-magnus';
...
const errorMessages = {
  'auth/email-already-in-use': 'O e-mail fornecido já está em uso. Por favor, utilize outro e-mail.',
  'auth/invalid-email': 'O e-mail fornecido é inválido. Por favor, verifique e tente novamente.',
  'auth/operation-not-allowed': 'O cadastro de usuários está desabilitado no momento.',
